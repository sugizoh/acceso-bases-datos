...
public class Diccionario {
    ...
    ArrayList desmembrar(String miCadena) {
        ...
        int longPalabraSeparadora=0;
        
        //Auxiliar que usamos para ir guardando palabras no reservadas
        String noSeparadora = "";
        
        //Auxiliar booleano
        Boolean separadorOReservada=false;
        ...
        for (int i=0; i<longMiCadena; i++) {
            ...
            longPalabraSeparadora = esSeparadora(subCadena);
            
            //Si no hay una palabra reservada al principio
            if(longPalabraSeparadora<=0) {
                ...
                if(i==longMiCadena-1){
                    ...
                    miArrayList.add(new tuplaPalabra(noSeparadora, separadorOReservada));
                }
            ...
            //Si la primera palabra de la cadena que estamos analizando es palabra reservada
                ...
                miArrayList.add(new tuplaPalabra(miCadena.substring(i, i + longPalabraSeparadora), true));
                i = i + longPalabraSeparadora-1;
            }
