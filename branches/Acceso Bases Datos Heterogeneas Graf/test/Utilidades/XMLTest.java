...
public class XMLTest {
    ...
    public void testConfiguracionXML() throws RuntimeException, SAXException, IOException, ParserConfigurationException {
        ...
        XML xml = new XML("testXML/testConfiguracion.xml", "basedatos");
...
/*
    @Test
    public void testRaroXML() throws RuntimeException, SAXException, IOException, ParserConfigurationException {
        System.out.println("Creando objeto XML de testRaro.xml");
        XML xml = new XML("testXML/testRaro.xml", "tupla1", "bbcc", "pawfe");

        HashMap<String,Object> hashMap = xml.getXmlLeido();
        HashMap<String, HashMap<String, String>> hashMapExp = new HashMap<String, HashMap<String, String>>();

        HashMap<String, Object> hashMapTupla1 = new HashMap<String, Object>();
        hashMapAmazon.put("conexion".toUpperCase(), "jdbc:mysql://localhost/Amazon");
        hashMapAmazon.put("usuario".toUpperCase(), "root");
        hashMapAmazon.put("password".toUpperCase(), "root");

        HashMap<String, Object> hashMapTupla2 = new HashMap<String, Object>();
        hashMapCasaDelLibro.put("conexion".toUpperCase(), "jdbc:mysql://localhost/CasaDelLibro");
        hashMapCasaDelLibro.put("usuario".toUpperCase(), "root");
        hashMapCasaDelLibro.put("password".toUpperCase(), "root");
